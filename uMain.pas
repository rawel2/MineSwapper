...
begin
  if Win then
    MessageBox(0,PWideChar('Rozminowa³eœ grê w czasie '+FormatDateTime('hh:mm:ss',fmMain.czas/SecsPerDay)+' !!!'), PWideChar('Sukces!'), MB_ICONINFORMATION)
  else
    MessageBox(0,PWideChar('Trafi³eœ na minê w czasie '+FormatDateTime('hh:mm:ss',fmMain.czas/SecsPerDay)+' !!!'), PWideChar('B³¹d!!!'), MB_ICONERROR);
end;
...
begin
  czas := czas+1;
  StatusBar1.Panels[2].Text := FormatDateTime('hh:mm:ss',czas/SecsPerDay);
end;
